 ...
 * It supports non-blocking reads of single keystrokes without echo.
 */
public class RawConsoleInput {

    // variable indicate whether the program is running on Windows
...
// The Windows version uses _kbhit() and _getwch() from msvcrt.dll.
     ...
     * -1 on EOF.
     * Otherwise, a Unicode character code within the range 0 to 0xFFFF.
     */
